...
const FAQ_ITEMS: FaqItem[] = [
  {
    ...
    answer: (
      <>
        ...
        <Link href="/wallet/charge" className="font-bold text-[#1A56DB] hover:underline">
          캐시 충전
        </Link>
  ...
  },
  {
    ...
    answer: (
      <>
        <Link href="/mentors" className="font-bold text-[#1A56DB] hover:underline">
          멘토 찾기
        </Link>
  ...
  },
  {
    ...
    answer: (
      <>
        ...
        <Link href="/notices" className="font-bold text-[#1A56DB] hover:underline">
          공지사항
        </Link>
        을 확인해 주세요.
      </>
  ...
  },
  {
    ...
    answer: (
      <>
        ...
        <Link href="/custom-request" className="font-bold text-[#1A56DB] hover:underline">
          맞춤의뢰
        </Link>
        메뉴에서 요청을 올리고 멘토 제안을 비교할 수 있어요. 대필·제출용 대행 등은 허용되지 않습니다.
      </>
    ),
  },
];
