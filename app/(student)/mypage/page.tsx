    ...
    >
      <div className="space-y-6">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <section className="flex min-h-[160px] flex-col justify-between rounded-2xl border border-slate-200/80 bg-white p-6 shadow-sm">
            <div>
            ...
            <p className="mt-2 text-xs font-medium leading-tight text-slate-500">
              캐시 충전 및 이용 내역 바로가기
            </p>
            <div className="mt-4 flex select-none flex-wrap gap-2">
              <Link
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
          ...
          <section className="flex min-h-[160px] flex-col justify-between rounded-2xl border border-slate-200/80 bg-white p-6 shadow-sm md:col-span-2 lg:col-span-1">
            <div>
