    ...
    <CommunityLayoutShell
      ...
      hero={
        <CommunityPageHero
          eyebrow="멘토 · 커뮤니티 · 새 글"
          title="커뮤니티 작성"
          description="멘토 전용입니다. 게시판 글 또는 숏폼 영상 항목을 선택해 등록합니다. 저장 후 목록·상세로 이동하며, 출처 표기와 권리 확인에 동의해야 제출할 수 있습니다. 질문방·캐시와는 별도입니다."
          ctas={[
