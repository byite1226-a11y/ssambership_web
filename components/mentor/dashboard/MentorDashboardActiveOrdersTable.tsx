    ...
    <section className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
      <div className="flex items-center justify-between border-b border-slate-100 px-5 py-4">
        ...
        <Link
          ...
          className="text-[12px] font-bold text-[#1A56DB] hover:underline"
        >
          전체 보기 &gt;
        </Link>
      </div>
            ...
            <li key={order.id}>
              ...
              >
                <div className="col-span-4 min-w-0 lg:col-span-5">
                  <p className="truncate text-[13px] font-bold text-slate-900 group-hover:text-[#1A56DB]">
                    {order.title}
                  </p>
                ...
                <div className="col-span-2 flex min-w-0 items-center gap-2">
                  <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-blue-50 text-[11px] font-black text-[#1A56DB]">
