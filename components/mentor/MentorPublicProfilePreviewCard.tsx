...
export function MentorPublicProfilePreviewCard(props: MentorPublicProfilePreviewCardProps) {
  ...
  // preview(학생 시점): 사방 4px 테두리로 좌측 섹션 카드와 시각 무게를 맞추되, 색은 브랜드 파랑 계열 옅은 톤(blue-200). 좌측 바는 넣지 않음.
  const borderCls = isDense ? "border border-slate-200" : "border-[4px] border-blue-200";
